...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        //①数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/woniu_sys?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.woniuxy.cq");
        pc.setModuleName("ssmboot39");
...
//        strategy.setSuperEntityColumns("id");
        ...
        strategy.setTablePrefix("woniu_");
